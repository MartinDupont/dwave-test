...
provinces = ['AB', 'BC', 'MB', 'NB', 'NS', 'ON', 'PE', 'QC', 'SK', 'YT']
neighbors = [('AB', 'BC'), ('AB', 'SK'), ('BC', 'YT'),
             ('MB', 'ON'), ('MB', 'SK'), ('NB', 'NS'), ('NB', 'QC'), ('ON', 'QC')]
...
if run_new:
    ...
    pickle.dump(response, open('result_simplified_more{}.pickle'.format(version), "wb"))
else:
    response = pickle.load(open('result_simplified_more{}.pickle'.format(version), "rb" ))
